<template>
    <main class="px-8 lg:px-24 pt-24">
        ...
        <p>
            <b>HEMIBLADE SOFTWARE</b> operates the <a href="https://hemiblade.com">https://hemiblade.com</a> website, which provides the SERVICE.
        </p>
        <p>
            This page informs website visitors about our policies regarding the collection, use, and disclosure of Personal Information if anyone decides to use our Service, the HEMIBLADE SOFTWARE website.
            <br /> <br />
            ...
            <br /> <br />
            The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which are accessible at <a href="http://hemiblade.com">http://hemiblade.com</a>, unless otherwise defined in this Privacy Policy
        </p>
        <h2>
        ...
        <p>
            Our Services do not address anyone under the age of 13. We do not knowingly collect personal identifiable information from children under 13. In the case we discover that a child under 13 has provided us with personal information, we immediately delete this from our servers. If you are a parent or guardian and know that your child has provided us with personal information, please contact us so we can do the necessary actions.
        </p>
        <h2>
...
<style scoped>
    h2 {
        @apply font-bold text-gray-8 my-5 uppercase text-2xl;
    }
    ul {
    ...
    li {
        @apply text-gray-8 text-xl mb-2;
    }
    p {
        @apply text-gray-8 text-xl mb-5;
    }
    p a {
        @apply hover:text-yellow-3 underline transition;
    }
</style>