<template>
    <footer class="flex flex-col bg-gray-9 text-white py-6 lg:pt-12 px-10 sm:px-28">
        <div class="flex flex-wrap justify-between">
            <FooterForm />
            <div class="flex flex-col">
                <div class="flex flex-col">
                    <h4 class="font-medium  text-white text-2xl mb-2">Get in Touch via Email</h4>
                    <a class="flex text-[#b3b3b3] font-regular text-lg hover:text-yellow transition-all cursor-pointer"  href = "mailto: abc@example.com">
...
export default {
    ...
    data() {
        return {
            sections: [
                { title: 'Home', section: "#portrait", offset: -300 },
                { title: '[ IFA ]', section: "#showcase", offset: -180 },
