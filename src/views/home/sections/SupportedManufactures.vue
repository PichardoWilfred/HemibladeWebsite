<template>
    <div class="relative flex flex-col pt-6 pb-16 border-b border-b-gray-2 min-h-[280px]">
        ...
        <section class="flex relative overflow-hidden justify-center bg-white max-lg:flex-wrap max-lg:min-h-[420px] lg:h-[380px] xl:h-[320px]">

            <div class="flex max-lg:flex-wrap relative justify-center bg-white w-full" :style="physical_slide">
            ...
            <div class="visual-slide" :style="visual_slide">
                <div v-for="{class_, text, alt, img} in slide" class="flex max-lg:flex-wrap justify-center bg-white h-full w-full">
                    <div class="image-container">
...
<style scoped>
.image-container {
    @apply flex content-center justify-center w-[380px] max-lg:my-10 lg:ml-[6.1vw] lg:mr-[8vw];
}
img.manufactures {
    max-width: unset;
